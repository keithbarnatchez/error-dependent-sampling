...
path <- '../output/sim_results-2025-02-03-21-08-10.csv' # '../output/sim_results-2025-02-03-11-23-37.csv'  # '../output/sim_results-2025-01-20-08-07-44.csv'   #  '../output/sim_results-2024-09-05-07-34-53.csv'
...
ggsave('../figures/rmse-plot-n-grid-with-naive.pdf',width=8,height=4,units = 'in')
